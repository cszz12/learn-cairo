...
# sys.path.insert(1, '/Users/wanghusen/Documents/GitHub/cairo/cairo-lang/src/starkware/crypto/')

from cairo-lang.starkware.crypto.starkware.crypto.signature.signature import (
